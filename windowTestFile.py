...
cap = cv2.VideoCapture(1)   #Establishes "cap" as the source
...
while(1):       # This is a simple continuous loop that recursively grabs frames from the system default camera.
    ...
    contours, hierarchy = cv2.findContours(maskcopy,cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)     # Find the contours
